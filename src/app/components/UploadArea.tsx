  ...
  return (
    <div className="w-auto flex items-center justify-center">
      <div className="w-[336px] md:w-[500px] lg:w-[806px] xl:w-[906px] 2xl:w-[1100px] h-[636px] md:h-[564px] 2xl:h-[626px] flex items-center md:mt-10 gap-4">
        ...
        <div className="flex items-center justify-center flex-col w-[290px] 2xl:w-[344px] h-[528px] 2xl:h-[626px] mt-auto max-md:hidden">
          <img
            src="/images/machine.png"
            className="w-[228.5px] h-[136.5px] flex align-center"
          ></img>
          <div className="bg-white rounded-2xl border border-custom-border">
            <h1 className="font-Mont font-extrabold text-3xl leading-9 text-[#6947BF] p-10">
              Evaluate your x with a single click
            </h1>
            <img
              src="/images/GradeReport.png"
              className="w-[290px] h-[248px] position-absolute right-16 bottom-0"
            ></img>
          </div>
        </div>
      </div>
